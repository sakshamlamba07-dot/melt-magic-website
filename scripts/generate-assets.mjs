...
const siteUrl = 'https://elysianresinatelier.com';

const productSlugs = [
  'aurora-tide-serving-board',
  'obsidian-bloom-wall-panel',
  'champagne-current-coasters',
  'lumen-river-console',
  'ivory-veil-jewelry-dish',
  'nocturne-marble-tray'
];
...
function makeFaviconSvg() {
  return `<?xml version="1.0" encoding="UTF-8"?>
<svg width="128" height="128" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Elysian Resin Atelier monogram">
  <defs>
  ...
  <path d="M35 91V37h37v9H47v13h22v9H47v14h27v9H35Zm49 0L70 68l14-31h12L82 68l15 23H84Z" fill="#fff8e7"/>
</svg>`;
}
...
async function writeHDR(filePath, width = 96, height = 48) {
  const header = Buffer.from(
    `#?RADIANCE
# Procedural champagne studio HDRI generated for Elysian Resin Atelier
...
function createGLB(mesh) {
  ...
  const gltf = {
    asset: {
      version: '2.0',
      generator: 'Elysian Resin Atelier procedural GLB generator'
    },
    ...
    meshes: [
      {
        name: 'Polished superellipse resin board',
        primitives: [
          {
            attributes: {
              POSITION: 0,
    ...
    materials: [
      {
        name: 'Translucent champagne resin',
        alphaMode: 'BLEND',
        doubleSided: false,
...
async function main() {
  ...
  const art = [
    {
      file: 'product-aurora-tide.svg',
      title: 'Aurora Tide',
      subtitle: 'champagne current serving board',
      colors: ['#070606', '#102a31', '#8edfea', '#d6b06a', '#fff7e6'],
      seed: 11
    },
    {
      file: 'product-obsidian-bloom.svg',
      title: 'Obsidian Bloom',
      subtitle: 'black resin botanical wall panel',
      colors: ['#050505', '#151111', '#41304c', '#c99c55', '#fff0d2'],
      seed: 22
    },
    {
      file: 'product-champagne-current.svg',
      title: 'Champagne Current',
      subtitle: 'gilded translucent coaster set',
      colors: ['#080706', '#2a2118', '#d6bf8c', '#f1c86c', '#fff8e7'],
      seed: 33
    },
    {
      file: 'product-lumen-river.svg',
      title: 'Lumen River',
      subtitle: 'sculptural console river pour',
      colors: ['#060707', '#16191b', '#8fd0c8', '#bd8f4a', '#fff6df'],
      seed: 44
    },
    {
      file: 'product-ivory-veil.svg',
      title: 'Ivory Veil',
      subtitle: 'pearl resin jewelry dish',
      colors: ['#090806', '#30291f', '#f3e8cf', '#cda965', '#fffaf0'],
      seed: 55
    },
    {
      file: 'product-nocturne-marble.svg',
      title: 'Nocturne Marble',
      subtitle: 'smoked black polished tray',
      colors: ['#050506', '#111317', '#6c7280', '#c39a57', '#fff3da'],
      seed: 66
    },
    {
      file: 'og-image.svg',
      title: 'Elysian Resin Atelier',
      subtitle: 'handcrafted luminous resin objects',
      colors: ['#070606', '#17100d', '#88dce6', '#d2a45f', '#fff6e3'],
      seed: 88
    }
  ];
...
`,
    ...
    JSON.stringify(
      {
        ...
        short_name: 'Elysian Resin',
        description: 'Luxury handcrafted resin artwork and bespoke interior objects.',
        start_url: '/',
        display: 'standalone',
  ...
  console.log('Elysian Resin Atelier assets generated: SVG artwork, HDRI lighting, GLB model, SEO files.');
}
